...
class MoEOccupancyScale2(BEVDepth):
    def __init__(self, 
                voxel_size,
                n_voxels,
                loss_cfg=None,
        ...
        if use_rendering:
            ...
            self.color_head = MLP(input_dim=192, output_dim=3,net_depth=3,skip_layer=None)
            ...
            #     nn.Conv3d(192, 3, 3, 1, 1, bias=False),
            #     nn.Sigmoid(),
            # )
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        x = self.img_view_transformer(img_feats, img_metas)
