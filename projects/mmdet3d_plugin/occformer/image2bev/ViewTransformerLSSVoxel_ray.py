...
from .ViewTransformerLSSBEVDepth_ray import *

@NECKS.register_module()
class ViewTransformerLiftSplatShootVoxel_Ray(ViewTransformerLSSBEVDepth_Ray):
    def __init__(
            self, 
            loss_depth_weight,
            scale=16,
        ...
        super(ViewTransformerLiftSplatShootVoxel_Ray, self).__init__(loss_depth_weight=loss_depth_weight, **kwargs)
