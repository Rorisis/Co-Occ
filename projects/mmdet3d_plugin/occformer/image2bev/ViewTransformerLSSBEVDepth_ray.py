...
class ViewTransformerLSSBEVDepth_Ray(ViewTransformerLiftSplatShoot):
    def __init__(self, loss_depth_weight, cam_channels=27, loss_depth_reg_weight=0.0, use_voxel_net=False, **kwargs):
        super(ViewTransformerLSSBEVDepth_Ray, self).__init__(**kwargs)
...
@NECKS.register_module()
class ViewTransformerLSSBEVStereo_Ray(ViewTransformerLSSBEVDepth_Ray):
    def __init__(self, num_ranges=4, use_mask=True, em_iteration=3,
        ...
        super(ViewTransformerLSSBEVStereo_Ray, self).__init__(**kwargs)
        self.num_ranges = num_ranges
